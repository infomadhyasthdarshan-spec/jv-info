...
//   return (
//     <nav className="flex items-center bg-white py-2 overflow-hidden">
...
//             <Link
//               href={crumb.href}
//               className={`capitalize block max-w-xs truncate ${
//                 isLast
//                   ? 'text-black'
//                   : 'text-[#B2917A] hover:text-[#B2917A95]'
//               }`}
//             >
//               {crumb.name}
//             </Link>
...
//             {!isLast && (
//               <ChevronRight className="w-4 h-4 text-[#B2917A]" />
//             )}
//           </div>
//         );
//       })}
...
function NavigationBar() {
  ...
  const tabRefs = useRef([]); // <-- Refs for each tab
      ...
      <div className="bg-[#B2917A] py-5 px-4">
        <div className="lg:max-w-5xl 2xl:max-w-5xl mx-auto h-20">
          <h1 className="text-[32px] md:text-5xl lg:text-[32px] font-semibold text-white font-ssr tracking-wide">
            ...
            <span className="font-light text-xl  md:text-5xl lg:text-[22px]">
              {text.links.tabs.workshop.h2}
            </span>
          </h1>
        </div>
      </div>
