  ...
  return (
    <>
      <div className="max-w-5xl mx-auto px-3 md:px-0 py-8">
        ...
        <ul className="list-disc pl-5 space-y-2 page-content px-4 ">
        ...
        <div className='mt-10  md:px-0'>
          <h1 className="page-small-heading mb-6">Guidance – मागगदर्गन</h1>
          <ul className="list-disc pl-5 space-y-2 page-content">
            <li>‘Adhyayan’ or Study is not just a ‘self-study’ exercise. While reading and other media are important, guidance is ultimately only from a Human Being (Teacher) who has understood, in whom these ‘meanings’ reside; hence it is important to be in touch with a competent person you feel can guide you.</li>
          </ul>
        </div>
        <div className='mt-10  md:px-0'>
        ...
        <div className='mt-10'>
          ...
          {/* Bullet Points */}
          <ul className="list-disc px-4  list-outside page-content pl-5 space-y-4 text-[15px] leading-relaxed  ">
            <li>
            ...
            <li>
              ...
              <ul className="list-disc list-outside page-content pl-5 mt-2 space-y-1 text-sm  ">
                <li>
