    ...
    <>
      <div className="px-4 md:px-0 py-8 max-w-5xl mx-auto text-[#111] space-y-6">
        ...
        <div className='mt-16 mb-10'>
          ...
          <p className='mb-16 page-content'>Wisdom, Conduct and Values <strong>do not need to be ‘enforced’, or ‘learnt’.</strong> They are a <strong>natural outcome </strong>of Knowledge, of Understanding. Each Human has <strong>Natural Acceptance </strong>for these laws and values.</p>
        ...
        {/* section1 */}
          ...
          {/* Laws */}
          <ul className="list-disc list-outside ml-5 mb-16 space-y-2 page-content">
            <li>
        ...
        <p className="mb-4 page-content">
          <span className="">4 ‘Values in the Self’ (Conscious unit, Jeevan):</span> Happiness, Peace, Satisfaction, Bliss.
        </p>
        <p className="mb-4 page-content">
        ...
        {/* section2 */}
        {/* Ethics Section */}
        <h2 className="page-small-heading pt-14 mb-4">
          Ethics [निति]
        </h2>
        <p className="mb-4 page-content">
        ...
        <h2 className="page-small-heading mb-4 pt-16">Human Family</h2>
