...
function ContactLocation() {
  ...
  const filteredData =
    selectedState === null
      ? allStates
      : allStates.filter((s) => s.state === selectedState);

  return (
    <div className="lg:max-w-5xl 2xl:max-w-5xl mx-auto relative flex flex-col">
      <div>
        <h1 className="text-2xl font-bold mb-4 ssr-hading">
          Contacts by Location
        </h1>

        {/* Desktop Dropdown */}
        {/* Desktop Dropdown */}
        <div className="relative w-full max-w-[359px] hidden md:block">
          <button
          ...
          >
            <div className="flex items-center gap-2">
              <MapPin size={20} />
              {selectedState || "Choose a Location"}
            </div>
            <ChevronDown size={20} />
          </button>

          {showDropdown && (
            <div className="absolute top-full left-0 z-20 bg-white rounded-xl shadow-lg mt-2 max-h-[300px] overflow-auto w-full p-4">
              {/* Reset Filter Button */}
              <button
                onClick={() => {
                ...
                className="mb-2 w-full py-2 rounded-xl bg-gray-100   font-medium"
              >
                Reset Filter
              </button>
              {allStates.map((item, i) => (
                <label key={i} className="flex items-center gap-3   mb-2">
                  <input
                    ...
                    onChange={() => handleStateSelect(item.state)} // closes dropdown after select
        ...
        {/* Mobile Bottom Sheet */}
        <div className="relative w-full max-w-[359px] md:hidden">
          <button
          ...
          {showDropdown && (
            <>
              ...
              <div
                className="fixed bottom-0 left-0 w-full max-h-[80vh] bg-white rounded-t-xl shadow-lg z-20 p-4 transform transition-all duration-300 ease-in-out flex flex-col"
                style={{
              ...
              >
                ...
                <div className="overflow-y-auto space-y-4 flex-1 pr-2">
                  ...
                  <button
                    ...
                    className="mt-4 w-full py-2 rounded-xl bg-gray-100   font-medium"
                  >
                    Reset Filter
                  </button>
                  {allStates.map((item, i) => (
                    <label key={i} className="flex items-center gap-3  ">
                      <input
                        ...
                        checked={selectedState === item.state}
                        onChange={() => handleStateSelect(item.state)}
                        className="w-4 h-4 text-blue-500"
                      />
                      {item.state}
                    </label>
        ...
        <div className="mt-6">
          {filteredData.map((section, index) => (
            <div key={index} className="bg-white w-full rounded-xl shadow mb-6 p-4">
              ...
              {section.contacts.map((c, i) => (
                ...
                >
                  ...
                  <div className="md:hidden flex flex-col w-full">
                    <div className="font-semibold text-[15px] mb-1">{c.city}</div>
...
//     return (
//         <div className="lg:max-w-5xl 2xl:max-w-5xl min-h-screen mx-auto relative flex flex-col">
//             <div>
//                 {/* Heading */}
//                 <h1 className="text-2xl font-bold mb-4 ssr-hading">
//                     Contacts by Location
